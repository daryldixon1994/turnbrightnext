...
const H1 = tw.h1`text-[#001436] font-poppins text-[1.37rem] uppercase font-extrabold  lg:h-[120px]`;
    ...
    <Container>
      <LeftContainer>
        ...
        <Content>
          <Item>
            <Image src={Img1} alt="" />
            <H1>Ressourcen-Engpass:Entwicklung 2023 – 2025</H1>
            <P>
          ...
          <Item>
            <Image src={Img2} alt="" />
            <H1>Kommender Fachkräftemangel & globaler Ressourcen-Engpass</H1>
            <P>
